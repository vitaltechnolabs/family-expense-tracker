            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('tags.store') }}">
                        ...
                        <div>
                            <label for="tag_name" class="block font-medium text-sm text-gray-700">Tag Name</label>
                            <input id="tag_name"
                                ...
                                type="text" name="tag_name" :value="old('tag_name')" required autofocus />
                            @error('tag_name')
                        ...
                        <div class="mt-4">
                            <label for="category_id" class="block font-medium text-sm text-gray-700">Category
                                (Optional)</label>
